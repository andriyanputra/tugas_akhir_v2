...
$rs = mysql_query(
	"SELECT b.resiko_id AS id, e.NAMA_MASTER AS title, b.resiko_tanggal_start AS start, 
		...
		ON (d.ID_MASTER = e.ID_MASTER) WHERE b.resiko_tanggal_start BETWEEN '2014-09-01' AND '2014-09-31'
