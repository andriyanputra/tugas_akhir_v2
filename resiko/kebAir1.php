                        ...
                        <div class="page-content">
                            ...
                            <div class="row-fluid">
                                <div class="span12">
                                                        ...
                                                        <div id="potensi" class="tab-pane">
                                                            <div class="row-fluid">
                                                                <div class="span12">
                                                                    <div class="widget-box transparent">
                                                                        <div class="widget-header header-color-blue2">
                                                                            <h3>Perhitungan Potensi Pengangkutan Air
                                                                                 <span class="lbl">
                                                                                    <a href="#detail_peta" role="button" class="green" data-toggle="modal">
                                    ...
                                    <div id="detail_peta" class="modal hide fade" tabindex="-1">
                                        <div class="modal-header no-padding">
                                            <div class="table-header">
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                <dd align="center">Waktu Potensi Pengangkutan Air</dd>
                                                <dd>&nbsp;</dd>
                                            </div>
                                        </div>
