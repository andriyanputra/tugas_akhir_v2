                                        ...
                                        <div class="widget-box">
                                            ...
                                            <div class="widget-body">
                                                <div class="widget-main">
                                                    <div class="row-fluid">
                                                        <form class="form-horizontal" id="validation-form" method="post" action="Fsumber/prosesEdit.php?id=<?=$_GET['id']?>" enctype="multipart/form-data">
                                                            <div id="user-profile-3" class="user-profile">
                                                                <div class="row-fluid">
                                                                    ...
                                                                    <div class="control-group">
                                                                        ...
                                                                        <div class="controls">
                                                                            <input type="text" name="nama_sumber" id="nama_sumber" disabled="disabled" placeholder="Nama Sumber" value="<?= $d['NAMA_SUMBER'] ?>"/>
                                                                            &nbsp; &nbsp;
                                                                    ...
                                                                    <div class="control-group">
                                                                        ...
                                                                        if ($id > $batas){
                                                                            ...
                                                                            echo '<div class=controls>';?>
                                                                            <select disabled style="display:block;" id="lokasi_sumber" name="lokasi_sumber2" multiple="" class="chzn-select" data-placeholder="Pilih Lokasi...">
                                                                    ...
                                                                    <div class="control-group">
                                                                        <label class="control-label" for="lSumber">Lokasi Sumber Baru:</label>
                                                                        <?php
                    ...
                    <script type="text/javascript">
                        $(function() {
                            ...
                            $('#validation-form').validate({
                                ...
                                messages: {
                                    lokasi_sumber: "Mohon untuk memilih lokasi."
                                },
                                ...
                                submitHandler: function(form) {
                                    ...
                                    var v_lolSumber = $('select[name=lSumber]').val();
                                    ...
                                    $.post(url, {nama_sumber: v_nSumber, lokasi_sumber: v_lSumber, lSumber: v_lolSumber, ttl: v_ttl, keterangan: v_keterangan, phone: v_phone, gender: v_gender, email: v_email, pass1: v_pass1, jabatan: v_jabatan}, function() {
