...
(function (a, b) {
    a.fn.ace_wysiwyg = function (c, h) {
        ...
        this.each(function () {
            ...
            q.find("a[title]").tooltip({animation: false});
            ...
            q.find(".wysiwyg_colorpicker").each(function () {
                a(this).ace_colorpicker({pull_right: true, caret: false}).change(function () {
            ...
            var n = a.extend({}, {activeToolbarClass: "active", toolbarSelector: q}, d.wysiwyg || {});
            a(this).wysiwyg(n)
        });
        return this
    }
