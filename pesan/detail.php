...
if ((isset($_SESSION['pegawai_nomor']) && isset($_SESSION['level'])) || (isset($_COOKIE['level']) && isset($_COOKIE['pegawai_nomor']))) {
    ...
    $query = mysql_query("SELECT * FROM resiko AS a INNER JOIN pesan AS b ON (a.resiko_id = b.resiko_id)
                        WHERE b.pesan_id = '".$_GET['id']."' AND b.pesan_untuk = 'Staff Administrasi Umum'") or die("Query : ".mysql_error());
    if ($sql == false) {
        die(mysql_error());
        header('Location: ../login/login.php');
        exit();
                            ...
                            <div class="span12">
                                ...
                                <div class="row-fluid form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" readonly value="<?php echo $data['pesan_dari']; ?>">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="untuk">Pesan Untuk : </label>
                                        <div class="controls">
                                            <input type="text" readonly value="<?php echo $data['pesan_untuk']; ?>">
                                        </div>
                                    </div>
